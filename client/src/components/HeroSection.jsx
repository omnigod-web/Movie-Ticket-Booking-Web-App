...
const HeroSection = () => {
    ...
    return (
        ...
        px-6 md:px-16 lg:px-36 bg-[url("/saiyaara.jpeg")]
        bg-cover bg-center h-screen'>
            <img src={assets.marvelLogo} alt="" className='max-h-11 lg:h-11 mt-20' />

            <h1 className="text-3xl md:text-[70px] md:leading-18 font-semibold
                     max-w-110"> Gardians<br/>of the Galaxy</h1>
            ...
            <p className="max-w-md text-gray-300">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio autem
                voluptatum at animi fuga iusto  incidunt, in aliquam
                obcaecati. Ipsa tempora</p>
