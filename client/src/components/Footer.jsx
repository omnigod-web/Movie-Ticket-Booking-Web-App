...
const Footer =()=>{
    return(
       <footer className="px-6 pt-10 mt-10 md:px-16 lg:px-36 w-full text-gray-300">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96">
                    <img className="w-36 h-auto" src='./src/assets/omnilogo.png' alt="logo" />
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    <div>
                        <h2 className="font-semibold mb-5">Cinema</h2>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+1-234-567-89</p>
                            <p>nishant14022004@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © OmniGod1UI. All Right Reserved.
            </p>
        </footer>
    )
}
